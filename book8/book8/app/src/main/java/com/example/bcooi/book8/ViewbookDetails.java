...
public class ViewbookDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewbook_details);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_viewbook_details, menu);
        return true;
    }
    ...
    {
        BookSQL db = new BookSQL(ViewbookDetails.this);
        db.open();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            case R.id.menuAdd:
                ...
                Intent addbook =
                        new Intent(this, AddBookActivity.class);
    ...
    private void deleteBook()
    {
        ...
        dgbox.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                final BookSQL db = new BookSQL(ViewbookDetails.this);
                db.deleteBook(recID) ;
                finish();
            }
        });
